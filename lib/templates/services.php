...
<div class="wrap">
    <div class="myser-page-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
        <h1 style="margin: 0;">
            <img src="<?php echo MYSER_PLUGIN_URL; ?>assets/admin/images/icons/services.svg" class="myser-icon" alt="">
            <?php _e('Услуги', 'myser'); ?>
        </h1>
    ...
    <?php
    $myser_add_label  = '+ ' . __('Добавить услугу', 'myser');
    $myser_add_action = 'alert("Добавление услуги в разработке");';
    require MYSER_PLUGIN_DIR.'lib/templates/header-actions.php';
    ?>
    <p>Страница управления услугами (в разработке).</p>
</div>
